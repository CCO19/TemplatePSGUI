...
Ce script a pour objectif de fournir un template basique pour créer un WinForm professionnel, sans prompt Windows Terminal et avec une icône personnalisée en barre de titre ainsi qu'en barre de tâches.
